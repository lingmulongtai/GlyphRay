...
| Bluetooth mouse | Android mouse `MotionEvent` sends `MouseInput`; Windows injects cursor/buttons/wheel only for encrypted peers with mouse permission. | Add relative pointer-lock mode and high-resolution wheel handling. |
